<header class="header-body">
    ...
    <div class="header-item-login">
            ...
            @endif
            <div onclick="return confirm('Bạn có muốn đăng xuất không?')" class="header-item-logout">
                <a class="header-item-logout-text" href="{{ route('logout')}}"><i style="padding-right: 4px;" class="fa-solid fa-arrow-right-from-bracket"></i>Đăng xuất</a>
            </div>
            @endif
        </div>
    </div>
