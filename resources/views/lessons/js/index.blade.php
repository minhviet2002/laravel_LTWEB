...
<div class="lessonItem-body">
    <x-header-lesson title="Lập Trình JavaScript Cơ Bản"></x-header-lesson>
    <div class="tab-content">
        ...
        <ul class="pagination ml-auto">
            ...
            <li class="{{ ($js->currentPage() == ++$key) ? ' active' : '' }} page-item">
                <a class="page-link" href="{{ $js->url($key) }}">
                    ...
                    <div class="stepItem_desc">
                        ...
                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-play" class="svg-inline--fa fa-circle-play StepItem_lesson-icon_not" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    <div class="actionBar_wrapper">
        <button class="{{ ($js->currentPage() == 1) ? ' actionBar_btn_pre-disabled' : 'actionBar_btn-pre' }}">
            <a class="page-link-a" href="{{ $js->url($js->currentPage()-1) }}" aria-label="Previous">
                <i class="fa-solid fa-chevron-left"></i>
                BÀI TRƯỚC
            </a>
        </button>
        <button class="{{ ($js->currentPage() == $js->lastPage()) ? ' actionBar_btn_next-disabled' : 'actionBar_btn-next' }}">
            <a class=" page-link-a" href="{{ $js->url($js->currentPage()+1) }}" aria-label="Previous">
                BÀI TIẾP THEO
