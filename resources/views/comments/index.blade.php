...
<script>
    ...
    btnOptions.forEach((btnOption, index) => {
        btnOption.onclick = function() {
            if (document.querySelector('.comment-option-list.active')) {
                (document.querySelector('.comment-option-list.active')).classList.remove('active');
    ...
    reply_comments.forEach((reply_comment, index) => {
        reply_comment.onclick = function() {
            ...
            input_reply_comments[index].value = '';
            console.log(input_reply_comments[index]);
