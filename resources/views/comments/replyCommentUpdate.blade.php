...
<div class="content-comments">
    ...
    @endif
    <div class="form-wrap">
        <form action="{{ route('postUpdateReplyComment.index') }}" method="post" class="commentBox_commentWrapper">
            @csrf
            <div class="form-body">
                <i class="comment-item-ava-cmt fa-sharp fa-solid fa-user-tie"></i>
                <div class="form-body-input">

                    <input class="text_text commentBox_commentInput" value="{{ old('comment') ?? $commentUpdateDetail->content_reply}}" name="comment" type="text" placeholder="Bạn có thắc mắc gì không?">
                    @error('comment')
